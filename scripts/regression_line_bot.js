...
const cases = [
  ...
  },
  {
    ...
    user: 'audit-cjd',
    sequence: ['評鑑查核', '庫賈氏病'],
    expect: ['庫賈氏病評鑑查核重點', '風險辨識與勾稽', '侵入性處置前通知', '中高感染力組織器械', 'CJD 勾稽、排程、跨單位通知及器械處理紀錄', '50300-3-000013', '庫賈氏病感染管制措施'],
    forbid: ['Y:\\IFC_V', '115年感管查核全院宣導檔案', '對應條文', '4.1 主條文'],
    quick: ['院內勾稽紀錄', '手動勾稽', '風險判定', '器械處理', '中高感染力組織', 'KM佐證'],
    quickNot: ['通報定義', '隔離醫囑', '病人安置', '採檢送驗'],
  },
  {
    id: 'audit-cjd-infectivity-tissues-summary',
    user: 'audit-cjd-infectivity-tissues',
    sequence: ['評鑑查核', 'CJD 中高感染力組織有哪些'],
    expect: ['CJD 中、高感染力組織摘要', '高感染力（各型 CJD）', '腦、脊髓', '中感染力（各型 CJD）', '脊神經節、嗅覺上皮', 'vCJD／未確定型另注意', '扁桃腺', '淋巴結'],
    forbid: ['KM 可查閱佐證', '現場／系統執行紀錄', '可以查的範圍很多'],
  ...
  {
    id: 'clinical-actual-needlestick-urgent',
    user: 'clinical-actual-needlestick',
    q: '我被針扎了！怎麼辦？',
    expect: ['針扎／血液體液暴露後請先做立即處置', '流動清水和肥皂清洗', '不要刷洗或擠壓傷口', '立即通知單位主管', '暴露通報', 'HIV PEP'],
    forbid: ['抗藥性菌株與 MDRO', '感染管制處置與規範重點整理', '查核條文', 'VRE', 'CRE', 'CRAB', 'CRPA'],
    quick: ['HIV PEP', '檢驗追蹤'],
    quickNot: ['隔離醫囑', '病人安置', 'PPE防護', '清消', '解隔標準'],
  },
  {
    id: 'clinical-actual-needle-variant-traditional',
    user: 'clinical-actual-needle-traditional',
    q: '我被針紮了，要怎麼處理',
    expect: ['針扎／血液體液暴露後請先做立即處置', '流動清水和肥皂清洗', '立即通知單位主管', '暴露通報'],
    forbid: ['抗藥性菌株與 MDRO', '查核條文', 'VRE', 'CRE', 'CRAB', 'CRPA'],
    quickNot: ['隔離醫囑', '清消', '解隔標準'],
  },
  {
    id: 'clinical-actual-needle-variant-stab',
    user: 'clinical-actual-needle-stab',
    q: '護理師被針刺傷怎麼辦',
    expect: ['針扎／血液體液暴露後請先做立即處置', '眼睛或黏膜', '感染源／暴露者檢驗', 'HIV PEP'],
    forbid: ['抗藥性菌株與 MDRO', '感染管制處置與規範重點整理', '查核條文 5.2'],
    quickNot: ['隔離醫囑', '病人安置', '清消'],
  },
  {
    id: 'clinical-actual-sharps-injury',
    user: 'clinical-actual-sharps',
    q: '尖銳物扎傷處理流程',
    expect: ['針扎／血液體液暴露後請先做立即處置', '不要用漂白水', '暴露通報', '追蹤與結案'],
    forbid: ['抗藥性菌株與 MDRO', 'VRE', 'CRE', 'CRAB', 'CRPA'],
    quickNot: ['隔離醫囑', 'PPE防護', '解隔標準'],
  },
  {
    id: 'clinical-actual-blood-body-fluid-exposure',
    user: 'clinical-actual-blood-fluid',
    q: '同仁血體液暴露要通報嗎',
    expect: ['針扎／血液體液暴露後請先做立即處置', '立即通知單位主管', '暴露通報', '風險評估'],
    forbid: ['抗藥性菌株與 MDRO', '查核條文', 'VRE', 'CRE', 'CRAB', 'CRPA'],
    quickNot: ['隔離醫囑', '清消', '解隔標準'],
  },
  {
    id: 'clinical-actual-needle-head-puncture',
    user: 'clinical-actual-needle-head',
    q: '針頭刺到手流血',
    expect: ['針扎／血液體液暴露後請先做立即處置', '流動清水和肥皂清洗', '不要刷洗或擠壓傷口', '感染源／暴露者檢驗'],
    forbid: ['抗藥性菌株與 MDRO', '查核條文', 'VRE', 'CRE', 'CRAB', 'CRPA'],
    quickNot: ['隔離醫囑', '病人安置', '清消'],
  },
  {
    id: 'audit-mode-actual-needlestick-urgent',
    user: 'audit-actual-needlestick',
    sequence: ['評鑑查核', '我被針扎了！怎麼辦？'],
    expect: ['針扎／血液體液暴露後請先做立即處置', '流動清水和肥皂清洗', '不要刷洗或擠壓傷口', '立即通知單位主管', '暴露通報', 'HIV PEP'],
    forbid: ['抗藥性菌株與 MDRO', '感染管制處置與規範重點整理', '查核條文 5.2', '對應查核面向'],
    quick: ['立即處理', 'HIV PEP', '檢驗追蹤'],
  },
  {
  ...
  {
    id: 'stale-generic-audit-record-button-is-guarded',
    user: 'stale-generic-audit-record',
    sequence: ['評鑑查核', '熱門感控可出示執行紀錄'],
    expect: ['這是舊版快捷鈕', '沒有帶入原查核主題', '請重新輸入主題'],
    forbid: ['關鍵字檢索命中度較低', '文件、佐證與現場作答查核重點'],
    quick: ['內視鏡', '導管照護', '手部衛生', '傳染病通報'],
    quickNot: ['KM佐證', '執行紀錄'],
  },
  {
    id: 'stale-generic-audit-km-button-is-guarded',
    user: 'stale-generic-audit-km',
    sequence: ['評鑑查核', '熱門感控KM佐證'],
    expect: ['這是舊版快捷鈕', '沒有帶入原查核主題', '請重新輸入主題'],
    forbid: ['依查核主題至 KM', '文件、佐證與現場作答查核重點'],
    quick: ['內視鏡', '導管照護', '手部衛生', '傳染病通報'],
    quickNot: ['KM佐證', '執行紀錄'],
  },
  {
